// abre e fecha o menu quando clicar no ícone: 'hambuerger' e 'x'
...
// mudar o header da págiuna quando der scroll
...
// testimonials, script, carpusel, slider swiper
...
function activateMenuCurrentSection() {
  ...
  for (let section of sections) {
    ...
    let limitStart = chekpoint >= sectionTop
    let limittEnd = chekpoint <= sectionTop + sectionHeight

    if (limitStart && limittEnd) {
      document
